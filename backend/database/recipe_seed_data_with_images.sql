-- SmartMeal Recipe Seed Data WITH IMAGES
-- 30 diverse recipes with proper ingredients, instructions, and IMAGE URLS
-- Updated with Unsplash food images for a polished look
...
-- Insert 30 Global Recipes WITH IMAGE URLS
...
TRUE, UNIX_TIMESTAMP() * 1000, 'https://images.unsplash.com/photo-1645112411341-6c4fd023714a?w=400&q=80'),
...
TRUE, UNIX_TIMESTAMP() * 1000, 'https://images.unsplash.com/photo-1547592166-23ac45744acd?w=400&q=80'),
...
TRUE, UNIX_TIMESTAMP() * 1000, 'https://images.unsplash.com/photo-1546793665-c74683f339c1?w=400&q=80'),
...
TRUE, UNIX_TIMESTAMP() * 1000, 'https://images.unsplash.com/photo-1525351484163-7529414344d8?w=400&q=80'),
...
TRUE, UNIX_TIMESTAMP() * 1000, 'https://images.unsplash.com/photo-1541519227354-08fa5d50c44d?w=400&q=80'),
...
TRUE, UNIX_TIMESTAMP() * 1000, 'https://images.unsplash.com/photo-1540189549336-e6e99c3679fe?w=400&q=80'),
...
TRUE, UNIX_TIMESTAMP() * 1000, 'https://images.unsplash.com/photo-1528736235302-52922df5c122?w=400&q=80'),
...
TRUE, UNIX_TIMESTAMP() * 1000, 'https://images.unsplash.com/photo-1603133872878-684f208fb84b?w=400&q=80'),
...
TRUE, UNIX_TIMESTAMP() * 1000, 'https://images.unsplash.com/photo-1608897013039-887f21d8c804?w=400&q=80'),
...
TRUE, UNIX_TIMESTAMP() * 1000, 'https://images.unsplash.com/photo-1638176066666-ffb2f013c7dd?w=400&q=80'),
...
TRUE, UNIX_TIMESTAMP() * 1000, 'https://images.unsplash.com/photo-1516684732162-798a0062be99?w=400&q=80'),
...
TRUE, UNIX_TIMESTAMP() * 1000, 'https://images.unsplash.com/photo-1551504734-5ee1c4a1479b?w=400&q=80'),
...
TRUE, UNIX_TIMESTAMP() * 1000, 'https://images.unsplash.com/photo-1633504581786-316c8002b1b9?w=400&q=80'),
...
TRUE, UNIX_TIMESTAMP() * 1000, 'https://images.unsplash.com/photo-1588166524941-3bf61a9c41db?w=400&q=80'),
...
TRUE, UNIX_TIMESTAMP() * 1000, 'https://images.unsplash.com/photo-1467003909585-2f8a72700288?w=400&q=80'),
...
TRUE, UNIX_TIMESTAMP() * 1000, 'https://images.unsplash.com/photo-1624300629298-e9de39c13be5?w=400&q=80'),
...
TRUE, UNIX_TIMESTAMP() * 1000, 'https://images.unsplash.com/photo-1476124369491-c6041b90f9ab?w=400&q=80'),
...
TRUE, UNIX_TIMESTAMP() * 1000, 'https://images.unsplash.com/photo-1559314809-0d155014e29e?w=400&q=80'),
...
TRUE, UNIX_TIMESTAMP() * 1000, 'https://images.unsplash.com/photo-1604908176997-125f25cc6f3d?w=400&q=80'),
...
TRUE, UNIX_TIMESTAMP() * 1000, 'https://images.unsplash.com/photo-1603360946369-dc9bb6258143?w=400&q=80'),
...
TRUE, UNIX_TIMESTAMP() * 1000, 'https://images.unsplash.com/photo-1574071318508-1cdbab80d002?w=400&q=80'),
...
TRUE, UNIX_TIMESTAMP() * 1000, 'https://images.unsplash.com/photo-1618040996337-56904b7850b9?w=400&q=80'),
...
TRUE, UNIX_TIMESTAMP() * 1000, 'https://images.unsplash.com/photo-1547592166-b62fb43a127b?w=400&q=80'),
...
TRUE, UNIX_TIMESTAMP() * 1000, 'https://images.unsplash.com/photo-1632778149955-e80f8ceca2e8?w=400&q=80'),
...
TRUE, UNIX_TIMESTAMP() * 1000, 'https://images.unsplash.com/photo-1484723091739-30a097e8f929?w=400&q=80'),
...
TRUE, UNIX_TIMESTAMP() * 1000, 'https://images.unsplash.com/photo-1569718212165-3a8278d5f624?w=400&q=80'),
...
TRUE, UNIX_TIMESTAMP() * 1000, 'https://images.unsplash.com/photo-1512058564366-18510be2db19?w=400&q=80'),
...
TRUE, UNIX_TIMESTAMP() * 1000, 'https://images.unsplash.com/photo-1619566636858-adf3ef46400b?w=400&q=80'),
...
TRUE, UNIX_TIMESTAMP() * 1000, 'https://images.unsplash.com/photo-1567620905732-2d1ec7ab7445?w=400&q=80'),
...
TRUE, UNIX_TIMESTAMP() * 1000, 'https://images.unsplash.com/photo-1612874742237-6526221588e3?w=400&q=80');
